...
//        print("Called startUpdating")
    ...
    @IBAction func callPressed(sender: AnyObject) {
        if requestActive {
            ...
            callButton.setTitle("Call a Jaunt", forState: .Normal)
            requestActive = false
        }
        else {
            ...
            request.saveInBackgroundWithBlock {
                ...
                if success {
                    self.callButton.setTitle("Cancel Jaunt", forState: .Normal)
                    self.requestActive = true
                    if (self.driverComing == true )
                    {
                        self.callButton.setTitle("Driver On The Way! ", forState: .Normal)
                    }
                    ...
                    let alert = UIAlertController(title: "Could not call Jaunt", message: errorMessage! + "\nPlease try again", preferredStyle: .Alert)
